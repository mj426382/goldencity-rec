        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/properties" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 text-sm transition-colors duration-300">
                  Properties
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 text-sm transition-colors duration-300">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 text-sm transition-colors duration-300">
                  FAQ
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 text-sm transition-colors duration-300">
                  Privacy Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <Link to="#" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 transition-colors duration-300">
                <FiTwitter size={20} />
              </Link>
              <Link to="#" className="text-secondary-300 dark:text-secondary-400 hover:text-white dark:hover:text-primary-400 transition-colors duration-300">
                <FiLinkedin size={20} />
